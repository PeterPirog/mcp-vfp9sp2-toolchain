...
# Offline runtime dependency closure (Phase 2).
# OFFLINE_DEPENDENCY_VERSION_MISMATCH is intentionally kept DISTINCT from
# DEPENDENCY_VERSION_MISMATCH (Phase 1): the former covers the OFFLINE
# wheelhouse/lock (installed packages vs the lock manifest), the latter the
# vendored snapshot pins (VERSION.txt vs expected commit).
EC_OFFLINE_DEPENDENCY_MISSING = "OFFLINE_DEPENDENCY_MISSING"
EC_OFFLINE_DEPENDENCY_VERSION_MISMATCH = "OFFLINE_DEPENDENCY_VERSION_MISMATCH"
EC_OFFLINE_DEPENDENCY_HASH_MISMATCH = "OFFLINE_DEPENDENCY_HASH_MISMATCH"
EC_OFFLINE_DEPENDENCY_ORIGIN_MISMATCH = "OFFLINE_DEPENDENCY_ORIGIN_MISMATCH"
EC_OFFLINE_RUNTIME_INCOMPLETE = "OFFLINE_RUNTIME_INCOMPLETE"
